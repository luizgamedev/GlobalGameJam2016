...
namespace BitStrap
{
    ...
    public static class ArrayExtensions
    {
        ...
        /// <returns></returns>
        public static int Count<T>( this T[] collection, System.Predicate<T> callback )
        {
            if( callback == null )
                return 0;
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public static bool All<T>( this T[] collection, System.Predicate<T> callback )
        {
            if( callback == null )
                return false;
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public static bool Any<T>( this T[] collection, System.Predicate<T> callback )
        {
            if( callback == null )
                return false;
